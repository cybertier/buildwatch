...
def train():
    ...
    # bad phrases.
    good_probs = [avg_transition_prob(l, counts) for l in open(
        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'good.txt'))]
    bad_probs = [avg_transition_prob(l, counts) for l in open(
        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'bad.txt'))]
    ...
    with open(os.path.abspath(os.path.join(os.path.dirname(
            os.path.abspath(__file__)), 'gib_model.pki')), 'wb') as f:
